...
`derivedKey` ∈ `staticDefense`, `hpMax`, `mentalDefense`, `resolveMax`, `speed`, `resilience`.
...
**Exemplo de validação (Traya, livro p. 15)**: str 4, dex 3, con 4, wil 2, wis 2, cmp 2, size 5,
level 1 → Static Defense 15, HP máx. 12, Mental Defense 15, Resolve 4, Speed 7, Resilience 4.
